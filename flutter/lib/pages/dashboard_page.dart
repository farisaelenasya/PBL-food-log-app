...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _muatDataGlukosa() async {
    ...
    final nilaiList =
        data7.map((r) => (r['glucose_level'] as num).toDouble()).toList();

    // Isi dari terbaru ke terlama (balik urutannya untuk grafik)
    final grafik = List<double>.filled(7, 0);
    for (int i = 0; i < nilaiList.length && i < 7; i++) {
      grafik[6 - i] = nilaiList[i]; // terbaru di kanan
    }
        ...
        return [
          {
            ...
            'isi':
                'Gula darah Anda rendah (${_nilaiTerbaru.toStringAsFixed(0)} mg/dL). Segera konsumsi makanan/minuman manis dan istirahat.',
          },
          {
            ...
            'daftarMakanan': [
              {
                'nama': 'Jus buah murni / madu',
                'alasan': 'Naikkan gula darah dengan cepat'
              },
              {
                'nama': 'Pisang atau kurma',
                'alasan': 'Gula alami yang mudah diserap'
              },
              {
                'nama': 'Roti gandum dengan selai',
                'alasan': 'Energi cepat + tahan lama'
              },
              {
                'nama': 'Susu full cream',
                'alasan': 'Karbohidrat + protein seimbang'
              },
              {
                'nama': 'Biskuit asin',
                'alasan': 'Karbohidrat simpel untuk darurat'
              },
            ],
            'mode': 'anjuran',
          },
          {
            ...
            'daftarOlahraga': [
              {
                'nama': 'Hindari olahraga berat',
                'durasi': 'Sementara waktu',
                'ikon': Icons.block
              },
              {
                'nama': 'Stretching ringan',
                'durasi': '5–10 menit',
                'ikon': Icons.accessibility_new
              },
              {
                'nama': 'Istirahat cukup',
                'durasi': 'Prioritas utama',
                'ikon': Icons.hotel
              },
              {
                'nama': 'Jalan santai',
                'durasi': 'Setelah makan',
        ...
        return [
          {
            ...
            'isi':
                'Gula darah Anda normal (${_nilaiTerbaru.toStringAsFixed(0)} mg/dL). Pertahankan pola makan dan gaya hidup sehat Anda!',
          },
          {
            ...
            'daftarMakanan': [
              {
                'nama': 'Minuman bersoda & jus kemasan',
                'alasan': 'Tinggi gula tambahan'
              },
              {
                'nama': 'Kue manis & permen',
                'alasan': 'Gula sederhana berlebih'
              },
              {
                'nama': 'Gorengan berminyak',
                'alasan': 'Meningkatkan resistensi insulin'
              },
              {
                'nama': 'Nasi putih porsi besar',
                'alasan': 'Indeks glikemik tinggi'
              },
              {
                'nama': 'Makanan olahan/cepat saji',
                'alasan': 'Tinggi gula & sodium tersembunyi'
              },
            ],
          },
          {
            ...
            'daftarOlahraga': [
              ...
              {
                'nama': 'Senam ringan',
                'durasi': '20 menit pagi',
                'ikon': Icons.self_improvement
              },
              {
                'nama': 'Bersepeda santai',
                'durasi': '30 menit, 3×/minggu',
                'ikon': Icons.pedal_bike_outlined
              },
              {
                'nama': 'Renang',
                'durasi': '30 menit, 2×/minggu',
                'ikon': Icons.pool_outlined
              },
              {
        ...
        return [
          {
            ...
            'isi':
                'Gula darah Anda tinggi (${_nilaiTerbaru.toStringAsFixed(0)} mg/dL). Kurangi karbohidrat hari ini dan perbanyak gerak.',
          },
          {
            ...
            'daftarMakanan': [
              {
                'nama': 'Nasi, roti, mie putih',
                'alasan': 'Langsung naikkan gula darah'
              },
              {
                'nama': 'Minuman manis & boba',
                'alasan': 'Gula cair terserap sangat cepat'
              },
              {
                'nama': 'Buah manis (mangga, durian)',
                'alasan': 'Fruktosa tinggi'
              },
              {
                'nama': 'Gorengan & fast food',
                'alasan': 'Lemak trans memperparah kondisi'
              },
              {
                'nama': 'Kecap & saus manis',
                'alasan': 'Gula tersembunyi tinggi'
              },
            ],
          },
          {
        ...
        return [
          {
            ...
            'isi':
                'Gula darah Anda ${_nilaiTerbaru.toStringAsFixed(0)} mg/dL — sangat tinggi! Segera konsultasikan ke dokter dan minum air putih yang banyak.',
          },
          {
            ...
            'daftarMakanan': [
              {
                'nama': 'Semua makanan manis',
                'alasan': 'Berbahaya untuk kondisi ini'
              },
              {
                'nama': 'Karbohidrat sederhana',
                'alasan': 'Nasi, roti, mie — batasi ketat'
              },
              {
                'nama': 'Minuman bergula',
                'alasan': 'Termasuk jus & susu kental manis'
              },
              {
                'nama': 'Alkohol',
                'alasan': 'Sangat berbahaya saat gula tinggi'
              },
              {
                'nama': 'Makanan tinggi garam',
                'alasan': 'Memperburuk tekanan darah'
              },
            ],
          },
          {
            ...
            'daftarOlahraga': [
              {
                'nama': 'Jalan kaki santai',
                'durasi': '15–20 menit',
                'ikon': Icons.directions_walk
              },
              {
                'nama': 'Stretching pelan',
                'durasi': '10 menit',
                'ikon': Icons.accessibility_new
              },
              {
                'nama': 'Hindari olahraga berat',
                'durasi': 'Berbahaya saat ini',
                'ikon': Icons.block
              },
              {
                'nama': 'Perbanyak minum air',
                'durasi': '8+ gelas/hari',
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(_nilaiTerbaru.toInt().toString(),
                    style: const TextStyle(
                        fontSize: 38,
                        fontWeight: FontWeight.bold,
                        color: Color(0xFF1A1A2E))),
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text('${_rataRata7Hari.toStringAsFixed(0)} mg/dL',
                        style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Color(0xFF1A1A2E))),
  ...
  Widget _buildAksiCepat() {
    final daftarAksi = [
      ...
      },
      {
        ...
        'warna': const Color(0xFF00BFA5),
        'bg': const Color(0xFFE0F2F1),
        'judul': 'Pelacak Insulin',
        'subjudul': 'Catat dosis obat dan jenis insulin',
        'halaman': const InsulinTrackerPage()
      },
      {
        'ikon': Icons.edit_note_outlined,
        'warna': const Color(0xFFFF7043),
        'bg': const Color(0xFFFBE9E7),
        'judul': 'Catat Makanan Manual',
        'subjudul': 'Input makanan tanpa foto',
        'halaman': const CatatanMakananManualPage()
      },
      {
    ...
    return Container(
      ...
      child: ListTile(
        ...
        leading: Container(
          ...
          height: 44,
          decoration: BoxDecoration(
              color: aksi['bg'] as Color,
              borderRadius: BorderRadius.circular(12)),
          child: Icon(aksi['ikon'] as IconData,
              color: aksi['warna'] as Color, size: 22),
        ),
        title: Text(aksi['judul'] as String,
            style: const TextStyle(
                fontWeight: FontWeight.w600,
                fontSize: 14,
                color: Color(0xFF1A1A2E))),
              ...
              if (_nilaiTerbaru > 0)
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20),
                    border:
                        Border.all(color: badgeWarna.withValues(alpha: 0.4)),
                  ),
                  child: Text(
                    '$badgeTeks  ${_nilaiTerbaru.toStringAsFixed(0)} mg/dL',
                    style: TextStyle(
                      fontSize: 11,
                      fontWeight: FontWeight.w600,
                      color: badgeWarna,
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(12)),
                              child: Icon(tip['ikon'] as IconData,
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: ListView.builder(
                                    ...
                                    itemCount:
                                        (tip['daftarMakanan'] as List).length,
                                    itemBuilder: (_, j) {
                                      final item = (tip['daftarMakanan']
                                          as List)[j] as Map<String, String>;
                                      return Padding(
                                        padding:
                                ...
                                Expanded(
                                  child: ListView.builder(
                                    physics:
                                        const NeverScrollableScrollPhysics(),
                                    itemCount:
                                        (tip['daftarOlahraga'] as List).length,
                                    itemBuilder: (_, j) {
                                      final item = (tip['daftarOlahraga']
                                          as List)[j] as Map<String, dynamic>;
                                      return Padding(
                                        padding:
                                            const EdgeInsets.only(bottom: 6),
                                        child: Row(
